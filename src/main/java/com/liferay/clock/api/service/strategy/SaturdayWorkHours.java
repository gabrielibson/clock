...
/**
 * Saturday work hours strategy class.
...
public class SaturdayWorkHours implements WorkHoursCalculationStrategy{
	static double MULTIPLICATIVE_FACTOR = 1.5;
	
	/**
	 * Saturday work hours calculation strategy.
	 * @param time1 LocalDateTime check-in time
	 * @param time2 LocalDateTime check-out time
	 * @return Saturday work hours {@link Duration}
	 */
	@Override
